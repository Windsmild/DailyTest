...
public class RBTree<T extends Comparable<T>> {
    ...
    /**
     * add value to a new node,if this value exist in this tree, if value exist,it will return the exist value.otherwise return null if override mode
     * is true,if value exist in the tree, it will override the old value in the tree
     */
    ...
    /**
     * debug method,it used print the given node and its children nodes, every layer output in one line
     */
