...
public class ZhihuHomePageProcessor implements PageProcessor {
	...
	private Site site = Site.me().setRetryTimes(10).setSleepTime(5000).setTimeOut(5000)
			...
			.addCookie("z_c0", "Mi4xYkRRckFBQUFBQUFBRUVKM3dLc0pEQmNBQUFCaEFsVk5RUDdTV1FBVFRKN0VIX1Z4NVFEcU13ZktVUlFfZE8zRThB|1504407872|40557be833076391f968359269f35dcc986316a9")
	...
	public void process(us.codecraft.webmagic.Page page) {
		if (page.getUrl().regex(URL_ANSWERS).match()) {
			...
			String filePath = "/Users/caifeng/Downloads/zhihu/answers/"+userName;
			urlList.forEach(url -> {
				try {
	...
	public static void main(String[] args) {
		userName = "ArtoriaP";
		//个人主页的网址
		String url = "https://www.zhihu.com/people/ArtoriaP/answers";
